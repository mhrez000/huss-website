 ...
 * charcoal overlay and a single, unmissable gold CTA.
 */
    ...
    <section className="relative grain overflow-hidden py-32 sm:py-40">
      ...
      <Container className="relative">
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            <p className="eyebrow mb-5 !text-gold-soft">Book in two minutes</p>
            ...
            <div className="mt-10 flex flex-col items-center gap-5">
              ...
              <p className="text-sm text-cream/60">
                ...
                <a
                  ...
                  className="font-semibold text-cream underline-offset-4 transition-colors hover:text-gold-soft hover:underline"
                >
                  {site.phoneDisplay}
                </a>
              </p>
